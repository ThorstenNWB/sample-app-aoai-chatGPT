...
UI_TITLE = os.environ.get("UI_TITLE") or "FIB - Family Information Bot"
UI_LOGO = os.environ.get("UI_LOGO")
UI_CHAT_LOGO = os.environ.get("UI_CHAT_LOGO")
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Willkommen bei FIB!"
UI_CHAT_DESCRIPTION = (
    os.environ.get("UI_CHAT_DESCRIPTION")
    or "FIB hilft Dir gute Antworten zu finden"
)
